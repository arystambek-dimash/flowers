...
проигрывателю с вашей песней. Ниже сам собой разыгрывается ваш разговор,
который подводит к вопросу. А в конце — сам вопрос: **«Будешь моей
девушкой?»**, где кнопка «нет» отпрыгивает от пальца. После «да» экран
снова накрывает цветами, раскрывается письмо и последняя строка выводит
из экрана в жизнь — туда, где ты уже стоишь с настоящим букетом.
...
- **Диалог** разыгрывается сам, когда до него долистали: с «печатает…» и
  автопрокруткой, как в мессенджере. Он не просто милый — он подводит
  к вопросу, ради которого всё и собрано.
...
- **После «да»** — снова полный занавес из цветов, письмо печатается по
