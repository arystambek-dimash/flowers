...
Одностраничный сюрприз. Нажимаешь **«Открой меня»** — экран мгновенно
заливает сотнями цветов, и прямо за ними открывается пазл из вашей фотографии.
Дальше кнопок нет: просто листаешь вниз, и по пути снизу прорастает клумба,
играет пластинка с вашей песней, сам собой разыгрывается ваш диалог,
...
- **Пластинка.** Диск крутится, тонарм опускает иглу на дорожку, когда доходишь
  до секции; рядом стоит карточка Spotify. По проигрывателю можно щёлкнуть,
  чтобы остановить и снова запустить.
